...
try:
    ...
    for c in categories:
      ...
      for a in articles:
        ...
        content = a['content']
        category=c
    News.objects.create(source=source,author=author,title=title,description=description,url=url,urltoimage=urltoimage,publishedat=timestamp,content=content,category=category)
    connection.commit()
